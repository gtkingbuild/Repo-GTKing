...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[B][COLOR azure]GTKing[/COLOR] [COLOR gold]PHOENIX[/COLOR] [COLOR darkmagenta]OMEGA[/COLOR][/B]'
...
# Font size of header
FONTHEADER = ''
HEADERMESSAGE = '[B][COLOR azure]GTKing[/COLOR] [COLOR gold]PHOENIX[/COLOR] [COLOR darkmagenta]OMEGA[/COLOR][/B]'
