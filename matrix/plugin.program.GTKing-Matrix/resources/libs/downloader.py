...
class Downloader:
    ...
    def download(self, url, dest): 
        ...
        with open(dest, 'wb') as f:
            ...
            if total is None:
                ...
                for chunk in response.iter_content(chunk_size=max(int(total/512), mb)):
                    ...
                    currently_downloaded = '[COLOR azure][B]Descargando: [COLOR green]GTking PHOENIX...[/COLOR] [COLOR azure] -  Espere por Favor.[/B][/COLOR]'.format(CONFIG.ADDONTITLE)  + '\n' + '[COLOR %s][B]Tamaño:[/B] [COLOR %s]%.02f[/COLOR] MB de [COLOR %s]%.02f[/COLOR] MB' % (CONFIG.COLOR2, CONFIG.COLOR1, downloaded / mb, CONFIG.COLOR1, total / mb)
        ...
        if cancelled:
        	...
        	dialog.ok('[B][COLOR azure]GTKing[/COLOR] [COLOR red][B]PHOENIX[/COLOR] [COLOR lime][B]PHOENIX[/COLOR][/B]', '\n' + '[COLOR azure][B]Descarga Cancelada!![/B][/COLOR]')
        	quit()
