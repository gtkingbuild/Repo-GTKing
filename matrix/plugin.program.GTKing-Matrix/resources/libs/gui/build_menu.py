        ...
        if len(match) >= 1:
            if CONFIG.SEPARATE == 'true':
                ...
                if count19 > 0:
                    ...
                    directory.add_file('[B][COLOR dodgerblue]{0} BUILDS:[/COLOR] [COLOR azure]GTKING[/COLOR] [COLOR red]PHOENIX[/COLOR] [COLOR lime]TEAM[/COLOR][/B]'.format(state, count19), {'mode': 'togglesetting',
