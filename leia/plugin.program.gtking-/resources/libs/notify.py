...
def firstRun():
	class MyWindow(xbmcgui.WindowXMLDialog):
		...
		def doBuildMenu(self):
			wiz.log("[Check Updates] [Seleccionado: Abrir Build Menu] [Siguiente verificacion: %s]" % str(NEXTCHECK), xbmc.LOGNOTICE)
		...
		def doIgnore(self):
			self.close()
			wiz.log("[First Run] [Seleccionado: Ignorar Build Menu] [Siguiente verificacion: %s]" % str(NEXTCHECK), xbmc.LOGNOTICE)
			wiz.setS('lastbuildcheck', str(NEXTCHECK))
